...
public class QuickSort {
    ...
    private static <Item extends Comparable> Queue<Item> catenate(Queue<Item> q1, Queue<Item> q2) {
        Queue<Item> concatenated = new Queue<Item>();
        for (Item item : q1) {
    ...
    private static <Item extends Comparable> void partition(
        ...
        // Your code here!
        // Instantiate the empty queues in quickSort method, pass them into this partition method,
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\n");
        Queue<String> sortedEmpires = QuickSort.quickSort(empires);
